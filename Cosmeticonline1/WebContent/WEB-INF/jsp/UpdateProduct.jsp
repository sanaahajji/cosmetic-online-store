	...
	<div class="container">
					...
					<div>
						<div class="panel-heading"
							...
							<strong><a href="listofprod"><font
									style="color: white;">3. Product List </font> <img
		...
		<div class="result_rightDivpassowrd">
			...
			<div class="stipbg2">
				...
				<form id="updatenewprod" method="post" action="updatenewprod"
					class="form-horizontal" role="form">

<input type="hidden" id="pid" name="pid" value="${Productdata.pid}">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="productname"
								name="productname" placeholder="Enter Product Name" value="${Productdata.productname}"/>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="imgname"
								name="imgname"
								placeholder="Copy and paste in image1 Dir and image name here" value="${Productdata.imgname}"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="total"
								name="total"
								placeholder="total number of product" value="${Productdata.total}" />
						</div>
					</div>
					...
					<div class="form-group" style="margin-top: 0%;">
						...
						<div class="col-sm-8">
							<textarea id="proddesc" name="proddesc" class="form-control"
								cols="35" rows="8" placeholder="Describe Product here...">${Productdata.proddesc}</textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9" align="center" style="margin-left: 13%;">
							<button type="submit" class="btn btn-default" id="savebutton">Update
								Product</button>
